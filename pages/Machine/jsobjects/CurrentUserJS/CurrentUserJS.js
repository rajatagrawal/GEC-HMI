export default {
	...
	async getCurrentUserDataForMachine() {
		this.getUserNameAndPlantToShow_ForMachine();
	...
	async onPlantForCurrentUserChange() {
		...
		await this.setPlantToStoreForMachine(SelectPlants_SI_Modal.selectedOptionValue, SelectPlants_SI_Modal.selectedOptionLabel);
	...
	async setPlantToStoreForMachine(plantId, plantName) {
	...
	getUserNameAndPlantToShow_ForMachine() {
